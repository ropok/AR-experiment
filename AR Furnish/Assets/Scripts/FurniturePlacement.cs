...
{
    [SerializeField] private GameObject SpawnableFurniture;
    ...
    private void Update()
    {
        if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Began)
        {
            ...
            {
                bool collision = raycastManager.Raycast(Input.GetTouch(0).position, raycastHits, UnityEngine.XR.ARSubsystems.TrackableType.PlaneWithinPolygon);
